...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("/Users/nikospolizopoulos/Desktop/lotto5in.txt"));
             PrintStream ps = new PrintStream("/Users/nikospolizopoulos/Desktop/lotto5out.txt", StandardCharsets.UTF_8))  {
